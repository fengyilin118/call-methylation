...
ifdef cuda
    ...
    CUDA_OBJ = $(BUILD_DIR)/f5c_cuda.o $(BUILD_DIR)/f5c_cuda_gpuonly.o $(BUILD_DIR)/align_cuda.o $(BUILD_DIR)/hmm_cuda.o
    NVCC ?= nvcc
...
$(BUILD_DIR)/f5c.o: src/f5c.c src/f5c.h src/fast5lite.h src/f5cmisc.h src/hmm.h
	$(CXX) $(CFLAGS) $(CPPFLAGS) $(LANG) $< -c -o $@
...
$(BUILD_DIR)/hmm_cuda.o: src/hmm.cu src/hmm.h src/logsum.h src/fast5lite.h 
	$(NVCC) -x cu $(CUDA_CFLAGS) $(CPPFLAGS) -rdc=true -c $< -o $@
