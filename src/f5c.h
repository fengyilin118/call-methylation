...
typedef struct {
    ...
    //event table
    event_table* et;
    event_table* et_total;
    //scaling
    scalings_t* scalings;
    scalings_t* scalings_total;
...
typedef struct {
    ...
    char* host_read;
    ptr_t* host_read_ptr;
    ptr_t* host_alignment_ptr;
    AlignedPair* host_alignment;
    uint32_t* host_ref_start_pos; 
    ptr_t* host_event_ptr;
    event_t* host_event_table;
    scalings_t* host_scalings;
    float* unmethylated_score;
    float* methylated_score;
    uint8_t* host_rc;

    ptr_t sum_read_len = 0;
    ptr_t sum_alignment = 0;
    ptr_t sum_n_events = 0;

    //pipeline
    ptr_t* batch_ptr_read_ptr;
    ptr_t* batch_ptr_n_events;
    ptr_t* batch_ptr_event_ptr;
    ptr_t* batch_ptr_event_table;
    ptr_t* batch_ptr_event_align_pairs;
    ptr_t* batch_ptr_read_len;
    ptr_t* batch_ptr_scalings;
    ptr_t* batch_ptr_n_event_align_pairs;
    ptr_t* batch_ptr_read;
...
void process_db(core_t* dg, db_t* db, int32_t batch_id);
